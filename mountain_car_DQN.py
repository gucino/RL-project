...
#plot
plt.figure()
plt.title("reward vs episode (mountain car)")
plt.plot(np.arange(0,len(reward_list)),reward_list)
plt.xlabel("num episode")
plt.ylabel("reward")
plt.show()
plt.savefig("reward vs episode (mountain car)")

num_interval=200
smooth=smmooth(reward_list,num_interval)
plt.figure()
plt.title("reward vs episode (mountain car) (smoothed)")
plt.plot(np.arange(0,len(smooth)),smooth)
plt.xlabel("num episode")
plt.ylabel("reward")
plt.show()
plt.savefig("reward vs episode (mountain car) (smoothed)")
