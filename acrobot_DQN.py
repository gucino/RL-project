# -*- coding: utf-8 -*-
"""
Created on Mon Apr  6 16:48:28 2020
...
#plot
plt.figure()
plt.title("reward vs episode (acrobot)")
plt.plot(np.arange(0,len(reward_list)),reward_list)
plt.xlabel("num episode")
plt.ylabel("reward")
plt.show()
plt.savefig("reward vs episode (acrobot)")

num_interval=20
smooth=smmooth(reward_list,num_interval)
plt.figure()
plt.title("reward vs episode (acrobot) (smoothed)")
plt.plot(np.arange(0,len(smooth)),smooth)
plt.xlabel("num episode")
plt.ylabel("reward")
plt.show()
plt.savefig("reward vs episode (acrobot) (smoothed)")
